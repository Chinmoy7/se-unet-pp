...
class CrossEntropy2dLoss(nn.Module):
    ...
    def __init__(self, size_average=True, ignore_label=255):
        ...
        self.size_aaverage = size_average
...
class StableBCEDiceLoss(nn.Module):
    def __init__(self):
        super(StableBCEDiceLoss, self).__init__()
        self.dice = SoftDiceLoss()
...
class BoundaryWeightedLoss(nn.Module):
    ...
    def forward(self, inputs, targets):
        ...
        weights = Variable(torch.ones(avg_neighbors.size())).cuda()
